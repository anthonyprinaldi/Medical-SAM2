...
NAME = "SAMMED 2"
VERSION = "1.0"
DESCRIPTION = "SAMMED 2: Segment Anything in Medical Images and Videos"
URL = "https://github.com/anthonyprinaldi/Medical-SAM2"
AUTHOR = "AICONSLab"
LICENSE = "Apache 2.0"
...
EXTRA_PACKAGES = {
    "demo": ["matplotlib>=3.9.0", "jupyter>=1.0.0", "opencv-python>=4.10.0"],
